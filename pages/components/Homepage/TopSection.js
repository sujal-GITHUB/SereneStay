                ...
                <div class="card pb-5 mx-lg-5 mx-3" style={{ boxShadow: 'rgba(9, 30, 66, 0.25) 0px 4px 8px -2px, rgba(9, 30, 66, 0.08) 0px 0px 0px 1px', borderRadius: '20px' }}>
                    <div class="card-body mx-lg-5" style={{ marginTop: '-50px' }}>
                        ...
                        <div className="mt-3 mx-2">
                            <button type="button" class="btn mx-2" style={{ border: '2px solid #0B5ED7', background: '#D5E3FD', borderRadius: '20px', color: '#0B5ED7', fontSize: '15px' }}>Overnight Stays</button>
                            <button type="button" class="btn btn-outline-primary" style={{ borderRadius: '20px', fontSize: '15px' }}>Day Use Stays</button>
                        </div>
                        <div className="ms-3">
                            <Input id="input-with-icon-adornment" placeholder='Search Departure Place' className='px-2 mt-3 w-100' style={{ fontSize: '18px', height: '60px', borderRadius: '5px', border: '1px solid #DEE2E6' }} disableUnderline={true} startAdornment={<InputAdornment position="start"> <SearchIcon style={{ fontSize: '35px' }} /> </InputAdornment>} />
                        </div>
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="row ms-3 me-lg-0 me-1">
                                    <div className="col-6 p-0 m-0">
                                        <Input multiline id="input-with-icon-adornment" placeholder='28 Aug 2023 Wednesday' className='px-2 mt-3 w-100' style={{ fontSize: '18px', height: '60px', borderRadius: '0px', border: '1px solid #DEE2E6', borderTopLeftRadius: '5px', borderBottomLeftRadius: '5px' }} disableUnderline={true} startAdornment={<InputAdornment position="start"> <CalendarMonthIcon style={{ fontSize: '35px' }} /> </InputAdornment>} />
                                    </div>
                                    <div className="col-6 p-0 m-0">
                                        {/* <Input id="input-with-icon-adornment" placeholder='Return Date' className='px-2 mt-3 w-100' style={{ fontSize: '18px', height: '60px', borderRadius: '0px', border: '1px solid #DEE2E6', borderTopRightRadius: '5px', borderBottomRightRadius: '5px' }} disableUnderline={true} startAdornment={<InputAdornment position="start"> <CalendarMonthIcon style={{ fontSize: '35px' }} /> </InputAdornment>} /> */}
                                        <Input multiline id="input-with-icon-adornment" placeholder='30 Aug 2023 Wednesday' className='px-2 mt-3 w-100' style={{ fontSize: '18px', height: '60px', borderRadius: '0px', border: '1px solid #DEE2E6', borderTopRightRadius: '5px', borderBottomRightRadius: '5px' }} disableUnderline={true} startAdornment={<InputAdornment position="start"> <CalendarMonthIcon style={{ fontSize: '35px' }} /> </InputAdornment>} />
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6 ps-lg-0 ps-4">
                                <Input id="input-with-icon-adornment" placeholder='2 Adults' className='px-2 mt-3 w-100' style={{ fontSize: '18px', height: '60px', borderRadius: '5px', border: '1px solid #DEE2E6' }} disableUnderline={true} startAdornment={<InputAdornment position="start"> <PeopleAltIcon style={{ fontSize: '35px' }} /> </InputAdornment>} />
                            </div>
                        </div>
                        <div className="mt-4 ms-2">
                            <span className='bg-danger text-white py-1 px-2 mx-2' style={{ fontSize: '12px' }}>Bundle & Save</span>
                            <button type="button" class="btn text-primary mx-2" style={{ marginTop: '-5px', fontSize: '14px', fontWeight: '600' }}><span style={{ fontSize: '20px' }}>+</span> Add a flight</button>
                        </div>
                    </div>
                </div>
                <div className='px-4' style={{ maxWidth: '500px', margin: 'auto', marginTop: '-30px', position: 'relative' }}>
                    <button type="button" class="btn text-white w-100 py-2" style={{ fontSize: '24px', background: 'rgb(83, 146, 249)' }}>Search</button>
                </div>
            </div>
        </>
    )
